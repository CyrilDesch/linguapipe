...
import com.cyrelis.linguapipe.domain.transcript.{IngestSource, Transcript}
import com.cyrelis.linguapipe.infrastructure.adapters.driven.embedder.{HuggingFaceAdapter, HuggingFaceResponse}
